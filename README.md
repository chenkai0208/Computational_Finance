...
In this project, we use some classical numerical methods to conduct Monte Carlo simulations for the purpose of pricing European vanila options. The detailed explanation on the methods and procedures can be found in report1.[Contribution guidelines for this project](Kai_Chen_project1/Kai_Chen_report1.pdf)
